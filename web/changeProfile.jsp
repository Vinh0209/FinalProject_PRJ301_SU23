<%-- 
    ...
    Created on : 14-12-2023, 20:17:51
    Author     : BAO TRAN
--%>
            ...
            <c:otherwise>
                ...
                <form action="mainController" method="post">
                    <table>
                        <tr>
                            <td>New Full Name</td>
                            <td><input type="text" name="txtfullname" value="${param.txtfullname}" placeholder="Name"></td>
                        </tr>
                        <tr>
                            <td>New Phone Number</td>
                            <td><input type="text" name="txtphone" value="${param.txtphone}" placeholder="Phone"></td>
                        </tr>
                        <tr>
                            <td>New Password</td>
                            <td><input type="password" name="txtpass" value="${param.txtpass}" placeholder="Password"></td>
                        </tr>
