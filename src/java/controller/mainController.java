...
public class mainController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            else if(action.equals("manageDoraemon")) url="manageDoraemonServlet";
            ...
            else if(action.equals("searchDoraemon")) url="searchDoraemonServlet";
            ...
            else if(action.equals("updateDoraemonStatus")) url="updateDoraemonStatusServlet";
            else if(action.equals("getDoraemon")) url="getDoraemonServlet";
            ...
            else if(action.equals("addNewDoraemon")) url="addNewDoraemonServlet";
            else if(action.equals("deleteAllCart")) url="deleteAllCartServlet";
            else if(action.equals("updateDoraemon")) url="updateDoraemonServlet";
            else if(action.equals("updateDoraemonPage")) url="updateDoraemonPage.jsp";
